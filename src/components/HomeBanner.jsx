...
export default function HomeBanner() {
  return (
    <div>
      <div className="  after:bg-[linear-gradient(180deg,rgba(245,245,245,0)0%,#F5F5F5)] after:absolute after:z-0 w-full  h-[150vh] aspect-video after:h-[150vh] after:top-0  after:w-full">
        <video
          className="fixed w-full z-[-1]  h-[100vh] object-cover  bg-[linear-gradient(180deg,rgba(245,245,245,0)0%,#F5F5F5)]"
          loop
          muted
          autoPlay
        >
        ...
        <MaxWidthWrapper className={"relative  "}>
          <div className="absolute max-w-[clamp(400px,45vw,1026px)] font-[lust-text] text-[clamp(18px,6vw,121px)] leading-[clamp(18px,6vw,121px)] -translate-x-[20%] left-[20%] mt-[15%] ">
            {" "}
